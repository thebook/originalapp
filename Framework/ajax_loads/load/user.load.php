...
<div class="users_profile_box">
	...
	<div class="user_profile_box_minimize">-</div>
	<div class="user_profile_box_minimize">x</div>
	...
	<input data-function-to-call="remove_field" type="button" value="Remove Field" class="profile_button">
