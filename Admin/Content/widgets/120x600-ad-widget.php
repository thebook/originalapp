...
class lf_skyscraper_ad_widget extends WP_Widget { 

	function __construct() {
	
		$this->WP_Widget( 'skyscraper_ad_widget', 
						  'Ad : 120 x 600 Size Widget',
						  array(
							'classname' => 'lf-skyscraper-ad-widget',
							'description' => 'A skyscraper ad widget. Dimensions : 120 x 600.' ) );
	...
	function widget( $args, $instance ) {
		...
		lf_ad_widget_display( $instance, '120x600' );
...
register_widget( 'lf_skyscraper_ad_widget' );
