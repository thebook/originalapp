...
class lf_button_ad_widget extends WP_Widget { 

	function __construct() {
	
		$this->WP_Widget( 'button_ad_widget', 
						  'Ad : 125 x 125 Size Widget',
						  array(
							'classname' => 'lf-button-ad-widget',
							'description' => 'A button ad widget. Dimensions : 125 x 125.' ) );
	...
	function widget( $args, $instance ) {
		...
		lf_ad_widget_display( $instance, '125x125' );
...
register_widget( 'lf_button_ad_widget' );
