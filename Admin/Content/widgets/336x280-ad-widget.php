...
class lf_largerectangle_ad_widget extends WP_Widget { 

	function __construct() {
	
		$this->WP_Widget( 'largerectangle_ad_widget', 
						  'Ad : 336 x 280 Size Widget',
						  array(
							'classname' => 'lf-largerectangle-ad-widget',
							'description' => 'A large rectangle ad widget. Dimensions : 336 x 280. Do not put this widget into sidebars which are too small to fit it. Sidebars which are to small to fit it are quarter page size sidebars; therefore if a sidebar is larger than a quarter size sidebar, this widget will display properly. ' ) );
	...
	function widget( $args, $instance ) {
		...
		lf_ad_widget_display( $instance, '336x280' );
...
register_widget( 'lf_largerectangle_ad_widget' );
