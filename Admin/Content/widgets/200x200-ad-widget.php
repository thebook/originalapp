...
class lf_small_square_ad_widget extends WP_Widget { 

	function __construct() {
	
		$this->WP_Widget( 'small_square_ad_widget', 
						  'Ad : 200 x 200 Size Widget',
						  array(
							'classname' => 'lf-small-square-ad-widget',
							'description' => 'A small square ad widget. Dimensions : 200 x 200.' ) );
...
register_widget( 'lf_small_square_ad_widget' );
