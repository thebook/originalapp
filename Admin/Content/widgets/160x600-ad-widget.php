...
class lf_wideskyscraper_ad_widget extends WP_Widget { 

	function __construct() {
	
		$this->WP_Widget( 'wideskyscraper_ad_widget', 
						  'Ad : 160 x 600 Size Widget',
						  array(
							'classname' => 'lf-wideskyscraper-ad-widget',
							'description' => 'A wide skyscraper ad widget. Dimensions : 160 x 600.' ) );
	...
	function widget( $args, $instance ) {
		...
		lf_ad_widget_display( $instance, '160x600' );
...
register_widget( 'lf_wideskyscraper_ad_widget' );
