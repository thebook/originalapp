...
class lf_square_ad_widget extends WP_Widget { 

	function __construct() {
	
		$this->WP_Widget( 'square_ad_widget', 
						  'Ad : 250 x 250 Size Widget',
						  array(
							'classname' => 'lf-square-ad-widget',
							'description' => 'A square ad widget. Dimensions : 250 x 250. Do not put this widget into sidebars which are too small to fit it. Sidebars which are to small to fit it are quarter page size sidebars; therefore if a sidebar is larger than a quarter size sidebar, this widget will display properly. ' ) );
	...
	function widget( $args, $instance ) {
		...
		lf_ad_widget_display( $instance, '250x250' );
...
register_widget( 'lf_square_ad_widget' );
